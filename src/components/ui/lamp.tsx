    ...
    return (
        <LampContainer>
            <motion.h1
                ...
                className="mt-8 bg-gradient-to-br from-purple-300 to-blue-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
            >
                Interactive Robot <br /> Experience
            </motion.h1>
        </LampContainer>
    );
}
